...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($article,['method'=>'put','action'=>['admin\ArticleController@update',$article->id_article]]) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("article", "Article", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::textarea("article", null,['class' => 'form-control required']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("update", "Update", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::date("update", null,['class' => 'form-control required']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("photo", "Photo", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("photo", null,['class' => 'form-control required']) }}
