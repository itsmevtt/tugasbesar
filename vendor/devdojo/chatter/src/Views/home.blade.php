	...
	<div class="container chatter_container">
	    ...
	    <div class="row">
	    	...
	    	<div class="col-md-3 left-column">
	    		<!-- SIDEBAR -->
	    		<div class="chatter_sidebar" style="font-family: arial">
	        ...
	        <div class="col-md-9 right-column">
	        	<div class="panel">
		        	<ul class="discussions" style="font-style: arial">
				        	...
				        	<li>
				        		<a class="discussion_list" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
					        		...
					        		<div class="chatter_middle">
					        			...
					        			<span class="chatter_middle_details" style="font-family: arial">Posted By: <span data-href="/user" >{{ ucfirst($discussion->user->{Config::get('chatter.user.database_field_with_user_name')}) }}</span> {{ \Carbon\Carbon::createFromTimeStamp(strtotime($discussion->created_at))->diffForHumans() }}</span>
					        			...
					        			@endif
					        			<p style="font-family: arial">{{ substr(strip_tags($discussion_body), 0, 200) }}@if(strlen(strip_tags($discussion_body)) > 200){{ '...' }}@endif</p>
					        		</div>
